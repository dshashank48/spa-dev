            ...
            const itemRows = section.items.map(item => {
              return (
                <tr key={`item-${item.id}`}>
                  ...
                  <td
                    className={`border-b py-2 ${item.min ? "font-bold" : ""}`}
                  >
                    {item.min}
                  </td>
                  <td
                    className={`border-b py-2 ${item.max ? "font-bold" : ""}`}
                  >
                    {item.max}
                  </td>
                  <td
              ...
              <>
                ...
                {section.totalDefensive && (
                  <tr key={`totalDefensive`}>
                    ...
                    <td
                      className={`border-b py-2 ${
                        section.totalDefensive.current ? "font-bold" : ""
                      }`}
                    >
                    ...
                    <td
                      className={`border-b py-2 ${
                        section.totalDefensive.target ? "font-bold" : ""
                      }`}
                    >
                    ...
                    <td
                      className={`border-b py-2 ${
                        section.totalDefensive.proposed ? "font-bold" : ""
                      }`}
                    >
                ...
                {section.totalGrowth && (
                  <tr key={`totalGrowth`}>
                    ...
                    <td
                      className={`border-b py-2 ${
                        section.totalGrowth.current ? "font-bold" : ""
                      }`}
                    >
                    ...
                    <td
                      className={`border-b py-2 ${
                        section.totalGrowth.target ? "font-bold" : ""
                      }`}
                    >
                    ...
                    <td
                      className={`border-b py-2 ${
                        section.totalGrowth.proposed ? "font-bold" : ""
                      }`}
                    >
    ...
    <div className="asset-allocation-chart">
      <ResponsiveContainer width="100%" height={500}>
        ...
        >
          ...
          />
          <Tooltip
            formatter={(value, name, props) => [`${value}%`, name.slice(0, -5)]}
          ...
          />
          <Bar dataKey="proposedValue" fill="#F2C3A7" radius={[20, 20, 0, 0]} />
          <Bar dataKey="profileValue" fill="#6560A4" radius={[20, 20, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
    ...
    <Card title={data.attributes.title} className="overflow-y-auto">
      <div className="flex h-full flex-col">
        <p className="mb-4 max-w-4xl">
          ...
          portfolio following the implementation of our advice and describes any
          significant variations from the agreed target.
        </p>
        ...
        <div className="grid h-full grid-cols-12 items-start gap-4">
          ...
          <div className="col-span-5">
            ...
            <p className="mb-4 ml-8 max-w-4xl">
              ...
              allocation, your proposed portfolio is aligned within your target
              split between Growth and Defensive assets and the recommended
              minimum and maximum allocation for each asset class.
            </p>
          </div>
        </div>
      </div>
